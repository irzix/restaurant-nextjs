...
const STORY_MOBILE_BREAKPOINT = 1024;
  ...
  const STORY_BLOCKS = [
    {
      ...
      imageAlt: "Tuscan countryside",
      heading: t('block1.heading'),
      body: t('block1.description'),
    },
    {
      id: "02",
      image: "/images/wine_menu2.webp",
      imageAlt: "Wine and menu",
      heading: t('block2.heading'),
      body: t('block2.description'),
    },
    {
      id: "03",
      image: "/images/square_table.webp",
      imageAlt: "Dining table",
      heading: t('block3.heading'),
      body: t('block3.description'),
    },
  ];
