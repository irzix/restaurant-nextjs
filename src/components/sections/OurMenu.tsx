...
export function OurMenu() {
  ...
  const MENU_ITEMS = [
    {
      id: "bolognese",
      name: t('items.bolognese.name'),
      description: t('items.bolognese.description'),
      price: t('items.bolognese.price'),
      image: "/images/Bolognese.webp",
      imageAlt: "Bolognese pasta",
    },
    {
      id: "carbonara",
      name: t('items.carbonara.name'),
      description: t('items.carbonara.description'),
      price: t('items.carbonara.price'),
      image: "/images/Carbonara2.webp",
      imageAlt: "Carbonara pasta",
    },
    {
      id: "calamari",
      name: t('items.calamari.name'),
      description: t('items.calamari.description'),
      price: t('items.calamari.price'),
      image: "/images/Calamari.webp",
      imageAlt: "Fried calamari",
    },
    {
      id: "bistecca",
      name: t('items.bistecca.name'),
      description: t('items.bistecca.description'),
      price: t('items.bistecca.price'),
      image: "/images/Bistecca.webp",
      imageAlt: "Bistecca steak",
    },
    {
      id: "lasagna",
      name: t('items.lasagna.name'),
      description: t('items.lasagna.description'),
      price: t('items.lasagna.price'),
      image: "/images/Lasagna.webp",
      imageAlt: "Lasagna",
    },
    {
      id: "cacciatora",
      name: t('items.cacciatora.name'),
      description: t('items.cacciatora.description'),
      price: t('items.cacciatora.price'),
      image: "/images/Cacciatora.webp",
      imageAlt: "Cacciatora seafood",
    },
    {
      id: "branzino",
      name: t('items.branzino.name'),
      description: t('items.branzino.description'),
      price: t('items.branzino.price'),
      image: "/images/Branzino.webp",
      imageAlt: "Branzino fish",
    },
    {
      id: "ossoBuco",
      name: t('items.ossoBuco.name'),
      description: t('items.ossoBuco.description'),
      price: t('items.ossoBuco.price'),
