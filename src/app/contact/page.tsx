      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className={`${transitionClasses} ${isVisible ? visibleClasses : hiddenClasses}`} style={{ transitionDelay: "200ms" }}>
            <h2 className="font-gilda text-3xl text-[#f5f0e8] mb-8">Visit Our Sanctuary</h2>
            ...
            <div className="space-y-8">
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  <h3 className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-sm font-bold mb-2">Location</h3>
                  <p className="font-barlow text-[#a39e94] text-lg leading-relaxed">
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  <h3 className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-sm font-bold mb-2">Opening Hours</h3>
                  <p className="font-barlow text-[#a39e94] text-lg leading-relaxed">
                    Monday - Sunday: 12:00 PM - 11:00 PM<br />
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  <h3 className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-sm font-bold mb-2">Direct Contact</h3>
                  <p className="font-barlow text-[#a39e94] text-lg leading-relaxed">
                    +357 26 000000<br />
                    experience@kymacyprus.com
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 group overflow-hidden rounded-xl border border-[#c9a962]/20 relative aspect-video">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-[2px]">
                ...
                <div className="font-barlow-c text-[#c9a962] uppercase tracking-[0.2em] text-xs">Interactive Map Loading...</div>
              </div>
            </div>
          </div>
          ...
          <div className={`${transitionClasses} ${isVisible ? visibleClasses : hiddenClasses}`} style={{ transitionDelay: "300ms" }}>
            <div className="bg-[#1a1a1a]/50 backdrop-blur-md p-8 sm:p-12 rounded-2xl border border-[#c9a962]/10 relative overflow-hidden">
              ...
              <h2 className="font-gilda text-3xl text-[#f5f0e8] mb-2 relative z-10">Send a Message</h2>
              <p className="font-barlow text-[#a39e94] mb-10 relative z-10">We would love to hear from you. Please fill out the form below.</p>

              <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-[11px] font-bold">First Name</label>
                    <input type="text" className="w-full bg-[#111]/80 border-b border-[#c9a962]/20 focus:border-[#c9a962] px-0 py-3 font-barlow text-[#f5f0e8] outline-none transition-colors" placeholder="E.g. Alexander" />
                  </div>
                  <div className="space-y-2">
                    <label className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-[11px] font-bold">Last Name</label>
                    <input type="text" className="w-full bg-[#111]/80 border-b border-[#c9a962]/20 focus:border-[#c9a962] px-0 py-3 font-barlow text-[#f5f0e8] outline-none transition-colors" placeholder="E.g. Papas" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-[11px] font-bold">Email Address</label>
                  <input type="email" className="w-full bg-[#111]/80 border-b border-[#c9a962]/20 focus:border-[#c9a962] px-0 py-3 font-barlow text-[#f5f0e8] outline-none transition-colors" placeholder="alexander@example.com" />
                </div>

                <div className="space-y-2">
                  <label className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-[11px] font-bold">Subject</label>
                  <select className="w-full bg-[#111]/80 border-b border-[#c9a962]/20 focus:border-[#c9a962] px-0 py-3 font-barlow text-[#f5f0e8] outline-none transition-colors appearance-none cursor-pointer">
                    <option className="bg-[#111]">Reservation Inquiry</option>
                    <option className="bg-[#111]">Private Event</option>
                    <option className="bg-[#111]">General Question</option>
                    <option className="bg-[#111]">Feedback</option>
                  </select>
                </div>

                <div className="space-y-2">
                  <label className="font-barlow-c text-[#c9a962] uppercase tracking-widest text-[11px] font-bold">Message</label>
                  <textarea rows={4} className="w-full bg-[#111]/80 border-b border-[#c9a962]/20 focus:border-[#c9a962] px-0 py-3 font-barlow text-[#f5f0e8] outline-none transition-colors resize-none" placeholder="Tell us more about your request..."></textarea>
                </div>
